...
* find(float ga)
*
* Busca dentro del arbol de gananacia y revisa la ubicacion donde está ese nodo
...
* findFecha(string di)
*
* Busca dentro del arbol de fecha y revisa la ubicacion donde está ese nodo
* o deberia estar recordando que en AVL no se puede tener valores repetidos
*
* param string di
* return true o false
...
* si el balance es positivo o negativo, si es positivo, hace una rotación
